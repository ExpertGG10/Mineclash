...
schedule clear mineclash:powers/hefesto/gerar_automato/cancelar_automato
schedule function mineclash:powers/hefesto/gerar_automato/cancelar_automato 20t
...
function mineclash:powers/hefesto/gerar_automato/barra_automato with storage mineclash:automato
execute if score @s ferros matches 1.. run execute if score @s maximo = @s tempo_automato run function mineclash:powers/hefesto/gerar_automato/calcular_automato
