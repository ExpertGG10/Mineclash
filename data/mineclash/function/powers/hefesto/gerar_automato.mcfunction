...
schedule function mineclash:powers/hefesto/cancelar_automato 60t
...
tellraw @s {score: {name:"@s",objective:maximo}}
tellraw @s {score: {name:"@s",objective:tempo_automato}}
