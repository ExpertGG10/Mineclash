...
summon snowball ~ ~ ~ {Item:{id: snowball, components:{item_model:"gold_nugget"}},Tags:["projectile", "jato_de_lava"],Silent:1b,Invulnerable:1b,data:{},HasVisualFire:1b}
...
execute positioned ~ ~ ~ run kill @e[type=area_effect_cloud, distance=1]